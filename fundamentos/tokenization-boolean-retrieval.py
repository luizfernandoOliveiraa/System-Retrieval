"""
A utilização do modelo de retrieval boolean é realizar a recuperação dos e somente dos termos de uma pergunta.

Por exemplo, o corpo desse repositório é composto por documentos com frases de variadas sobre o universo de TI.

Quando o sistema recebe uma query buscando algo no tipo: "machine E learning", o sistema de retrieval é capaz de
buscar e retornar somente os documentos com a presença desses termos.

Sendo assim, esse modelo não é indicado para tarefas onde podemos ter sugestões parecidas, como é no modelo de recuperação
