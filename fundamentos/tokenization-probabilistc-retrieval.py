"""
A utilização do modelo de retrieval probabilístico é realizar a recuperação dos documentos mais relevantes com base em probabilidades de ocorrência de termos.
...
buscar e retornar os documentos mais relevantes a essa query, mesmo que não contenham exatamente os termos "machine" e "learning", mas sim termos relacionados.
